...
export const systemApi = {
  ...
  depts: () => http.get('/system/depts'),
  createDept: (data: any) => http.post('/system/depts', data),
  updateDept: (id: string, data: any) => http.put(`/system/depts/${id}`, data),
  removeDept: (id: string) => http.delete(`/system/depts/${id}`),

...
export class DictService {
  ...
  private usageMap: Record<string, { model: string; label: string; fields: string[] }[]> = {
    ...
    material_category: [{ model: 'dailyReport', label: '日报', fields: ['materialCategory'] }, { model: 'contractItem', label: '合同清单', fields: ['materialCategory'] }],
    material_type: [{ model: 'dailyReport', label: '日报', fields: ['materialType'] }],
    measurement_unit: [{ model: 'dailyReport', label: '日报', fields: ['unit'] }, { model: 'contractItem', label: '合同清单', fields: ['unit'] }],
